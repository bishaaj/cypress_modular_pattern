...
export class PreAppliedDiscretionaryDiscount {
    ...
    select_pre_applied_discretionary_discount_from_rule_type_dropdown() {
        commons.select_pre_applied_discretionary_discount_rule_type()
    }
    
    set_pre_applied_discretionary_discount_rule_name() {
        commons.add_pre_applied_discretionary_discount_rule_name()
    }

    set_pre_applied_discretionary_discount_value() {
        commons.add_pre_applied_discretionary_discount_value()
    }
    ...
    set_pre_applied_discretionary_discount_rule_condition_answer() {
    ...
    // set_pre_applied_discretionary_discount_rule_condition_answer_for_address() {

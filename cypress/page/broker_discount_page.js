...
export class BrokerDiscountPage {
    ...
    select_broker_discount_from_rule_type_dropdown() {
        commons.select_broker_discount_rule_type()
    }

    set_broker_discount_rule_name() {
        commons.broker_discount_rule_name()
    }

    select_broker_discount_amount_from_dropdown() {
        commons.broker_discount_charges()
    }

    enter_broker_discount_percentage() {
        commons.broker_discount_percentage_amount()
    }
    ...
    set_broker_discount_rule_condition_answer() {

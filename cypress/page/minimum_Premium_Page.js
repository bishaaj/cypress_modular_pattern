...
export class MinimumPremiumPage {
    ...
    select_minimum_premium_from_rule_type_dropdown() {
        commons.select_minimum_premium_rule_type()
    }

    set_minimum_premium_rule_name() {
        commons.add_minimum_premium_rule_name()
    }

    set_minimum_premium_value() {
        commons.add_minimum_premium_value()
    }

...
export class InstalmenPlanPage {
    ...
    select_instalment_plan_from_rule_type_dropdown() {
        commons.select_instalment_plan_rule_type()
    }

    set_instalment_plan_rule_name() {
        commons.instalment_plan_rule_name()
    }

    select_instalment_plan_amount_from_dropdown() {
        commons.instalment_plan_amount()
    }
    ...
    set_instalment_plan_rule_condition_answer() {
